...
public class Screen10_Stop_A implements Initializable {
    @FXML
    ...
    private void initializeCheckingID() throws SQLException {
        ...
        ResultSet set = Connect.getConnection().createStatement().executeQuery("select bankID, accountID from checking where protectionBank is not NULL and protectionAccount is not NULL;");
        while (set.next()) {
