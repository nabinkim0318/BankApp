...
public class Screen3 implements Initializable {
    ...
    private void onCreate() throws IOException {
        if (Objects.equals(Salary.getText(), "")) {
            Salary.setText(null);
        }
        if (Objects.equals(NumberOfPayments.getText(), "")) {
            NumberOfPayments.setText(null);
        }
        if (Objects.equals(AccumulatedEarnings.getText(), "")) {
            AccumulatedEarnings.setText(null);
        }
        try {
