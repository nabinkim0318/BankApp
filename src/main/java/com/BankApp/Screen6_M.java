...
public class Screen6_M implements Initializable {
    @FXML
    ...
    private void onBack() throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/Screen23.fxml"));
    ...
    private void onConfirm() throws SQLException, IOException {
        CallableStatement statement = Connect.getConnection().prepareCall("{call hire_worker(?, ?, ?)}");
